...
<body>
    ...
    <div class="alert alert-${type} alert-dismissible alert-danger" role="alert">
        <div class="text-center"><?php echo $_GET['Empty']?></div>
            ...
            <div class="card text-center shadow p-3 mb-5 bg-white rounded">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="../user/userlogin.php">User</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="container" style="width: 20rem;">
                    ...
                    <form class="mb-5 mt-5 ml-5 mr-5" method="post" action="usin.php">
                        <table cellspacing="8" cellpadding="8">
                            <tr>
                                <td colspan='2'>
                                    <h2 class="text-center py-3"><i class="fa-solid fa-mug-hot"></i>&nbspapebende.com
                                    </h2>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Password</thh>
                                <td><input type="password" name="upass" id="uhidepass"><br>
